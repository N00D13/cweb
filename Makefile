cweb: cweb.o helper.o servreq.o reqhead.o resphead.o resource.o
	gcc -o cweb cweb.o helper.o servreq.o reqhead.o resphead.o resource.o -Wall

cweb.o: cweb.c helper.h servreq.h
	gcc -o cweb.o cweb.c -c -ansi -pedantic -Wall
